...
class Animation_Data {
    ...
    public function __construct() {
        $this->players = $this->create_player_anims();
        $this->objects = $this->create_object_anims();
    }

    private function create_player_anims() {
        $player_anim_data = [
	    ...
	    for ($c1 = 0; $c1 < 7; $c1++) {
		    ...
		    for ($c2 = 0; $c2 < 4; $c2++) {
                $player_anims[$c1]['frame'][$c2] = array(
    ...
    private function create_object_anims() {
        $object_anims = [];
        $object_anim_data = [
